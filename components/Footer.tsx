...
export default function Footer() {
  return (
    <footer className="bg-[#001332] text-white py-12 border-t border-white/10 relative z-50">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        
        {/* Brand & Copyright */}
        <div className="text-center md:text-left">
          <h3 className="font-bold text-xl tracking-wide flex items-center justify-center md:justify-start gap-3">
             <img src="/fsh.png" alt="GMC Logo" className="h-6 w-auto brightness-0 invert" />
        ...
        <div className="flex items-center gap-6">
          {/* Email */}
          <a 
            href="mailto:ghsmathcircle@gmail.com" 
          ...
          {/* Instagram */}
          <a 
            href="https://www.instagram.com/gunnmathcircle/" 
            target="_blank" 
          ...
          {/* Discord */}
          <a 
            href="https://discord.gg/7EBjsHUppM" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-white/70 hover:text-white hover:scale-110 transition-all"
            aria-label="Discord"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 127.14 96.36" fill="currentColor" className="w-7 h-7">
