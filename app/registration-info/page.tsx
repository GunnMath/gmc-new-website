    ...
    <main className="bg-[#E4EFFF] min-h-screen text-[#002E67] relative overflow-x-hidden pt-32 pb-20">
      ...
      <div className="px-6 md:px-20 max-w-5xl mx-auto">
        <div className="text-center mb-12">
            ...
            <p className="text-xl font-semibold opacity-70">Everything you need to know to secure your spot at GMC 2026.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#002E67]/10">
                ...
                <div className="font-semibold opacity-80">March 22nd, 2026<br/>at 11:59 PM PST</div>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#002E67]/10">
            ...
            <div className="space-y-8">
                <div className="flex gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        <p className="font-semibold opacity-80">Visit <a href="https://contestdojo.com/register" target="_blank" rel="noopener noreferrer" className="text-[#155EA5] underline hover:text-[#002E67]">contestdojo.com/register</a> and select the &quot;Student&quot; account type to create your profile.</p>
                    </div>
                </div>
