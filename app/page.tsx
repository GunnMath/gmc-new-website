...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      setShowButton(window.scrollY > 300);"use client";
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl opacity-80 font-medium max-w-2xl mx-auto">
            Everything you need to know about round formats, scoring algorithms, competition integrity, and our prize pool.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-white/50 mb-12 text-[#002E67]">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-[#001332]/5 rounded-xl border border-[#002E67]/5">
                ...
                <p className="font-medium opacity-80 leading-relaxed">
                  Problems in the Team Round have <strong>fixed weights</strong>, with <strong>later problems weighing more</strong>. The <strong>maximum total point value</strong> for the team round is <strong>400</strong> for both divisions.
                </p>
            </div>
            <div className="p-4 bg-[#001332]/5 rounded-xl border border-[#002E67]/5">
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-white/50 text-[#002E67] mb-16">
            ...
            <ul className="space-y-3 font-medium opacity-80 list-disc pl-5">
                ...
                <li><strong>Writing utensils, protractors, and blank paper</strong> are the <strong>only tools allowed</strong> for ALL rounds (including the Estimathon and USAYNO).</li>
        ...
        <div className="bg-gradient-to-br from-blue-600/30 to-blue-800/30 border-2 border-blue-400/50 rounded-3xl p-8 md:p-12 text-center backdrop-blur-sm shadow-2xl mb-16">
          ...
          <p className="text-xl text-blue-100 font-medium leading-relaxed max-w-3xl mx-auto mb-8">
            Activities winners and overall prizewinners are eligible to select from our prize pool! 
            Choose from a selection of branded merchandise, high-end tech, educational math resources, and more.
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-[#002E67]">
              ...
              <div className="bg-white px-6 py-2 rounded-full font-bold shadow-md">Top 5 Teams Overall (Plaques)</div>
          </div>
        </div>
  ...
  return (
    <main className="bg-[#001332] min-h-screen text-[#E4EFFF] relative overflow-x-hidden">
      ...
      <div className={`fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 flex flex-col gap-4 transition-all duration-500 ease-out ${showButton ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
        <a 
          href="https://forms.gle/MDtV9LQ2k2QAer8h8"
          target="_blank" 
